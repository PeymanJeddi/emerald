        ...
        <div className="hidden border-r border-gold/20 bg-emerald-dark px-10 py-16 text-ivory lg:flex lg:flex-col lg:justify-between">
          <div>
            ...
            <p className="mt-8 max-w-md text-sm leading-relaxed text-ivory/85">
              Secure access to academic event submissions, certificate records, and scholarly
              participation documentation through the {SITE_NAME} applicant portal.
            </p>
          </div>
          <p className="text-xs tracking-wide text-ivory/50">
            Independent international scholarly congress & verification
          </p>
        </div>
